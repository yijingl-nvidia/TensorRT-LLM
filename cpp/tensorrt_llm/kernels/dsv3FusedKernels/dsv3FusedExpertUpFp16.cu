...
// DeepSeek-V3 fused expert-up FP16-MMA kernel.
//
// For each decode token (M <= 4), this kernel consumes router logits and bf16
// hidden states, applies the DeepSeek-V3 no-aux top-k routing rule, and
// computes shared/routed gate-up projections with FP8 weights unpacked into
// FP16 HMMA. The output is the routed top-k metadata and fp16 expert slots
...
#define DSV3_FUSED_EXPERT_UP_RAW_NAME dsv3_fused_expert_up_raw_fp16_mma
#endif

#ifndef DSV3_FUSED_EXPERT_UP_NAME
#define DSV3_FUSED_EXPERT_UP_NAME dsv3_fused_expert_up_fp16_mma
#endif
