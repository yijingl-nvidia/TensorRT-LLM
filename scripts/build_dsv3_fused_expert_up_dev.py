...
"""Build the standalone dsv3_fused_expert_up development Torch op."""
...
def main() -> None:
    ...
    sources = [
        src_dir / "cpp/tensorrt_llm/thop/dsv3FusedExpertUpDevOp.cpp",
        src_dir / "cpp/tensorrt_llm/kernels/dsv3FusedKernels/dsv3FusedExpertUp.cu",
    ]
    ...
    extra_cuda_cflags = [
        ...
        "-DDSV3_FUSED_EXPERT_UP_NAME=dsv3_fused_expert_up_dev_cuda",
        "-DDSV3_FUSED_EXPERT_UP_RAW_NAME=dsv3_fused_expert_up_raw_dev_cuda",
    ]
    extra_cuda_cflags.extend(
        shlex.split(os.environ.get("DSV3_FUSED_EXPERT_UP_DEV_EXTRA_CUDA_FLAGS", ""))
    )
    extra_ldflags = ["-lcuda"]
    extra_ldflags.extend(shlex.split(os.environ.get("DSV3_FUSED_EXPERT_UP_DEV_EXTRA_LDFLAGS", "")))
    ...
    load(
        ...
        verbose=os.environ.get("DSV3_FUSED_EXPERT_UP_DEV_VERBOSE", "1") != "0",
    )

    candidates = sorted(
        build_dir.glob("dsv3_fused_expert_up_dev*.so"),
    ...
    required_ops = ("dsv3_fused_expert_up_dev",)
